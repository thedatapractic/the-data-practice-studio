...
- 2026-07-20: Locked in a 5-template system in CLAUDE.md → "Script templates" (flagship teaching / search-intent direct-answer / day-in-the-life time-anchored / transformation-origin-story / listicle), replacing the old single "standard structure + identity structure" split. Every script must pick one template before drafting and state which + why (one line, logged) — never default to whichever template the last video used. Checked this against how real day-in-the-life, transformation, explainer, and listicle content performs before finalising (see production-log 2026-07-20 for the research). Video 1's reviewed draft used the teaching template's argument-building shape (a Decide/Translate/Foresee framework) — it needs a rebuild in the day-in-the-life (time-anchored) template, not just new content.
