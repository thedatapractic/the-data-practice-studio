...
3. Save to `scripts/drafts/`, update `backlog.md` status, and log the session in `production-log.md` (what was built/reworked, key decisions made along the way, per the usual reasoning-log format).
