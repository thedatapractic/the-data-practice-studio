...
6. **Ask Aji** whether there's a fresh, specific, vivid personal story, rule, or practice tied to *this* topic before falling back to `producer-memory.md`'s existing anecdote bank. The bank is a floor, not a ceiling — don't assume it already covers the topic just because it's non-empty. If Aji has nothing new, proceed with the bank and placeholders as below.
